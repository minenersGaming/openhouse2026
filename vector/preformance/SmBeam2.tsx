...
const SmBeam2: FC<{ className?: string }> = ({ className }) => {
  return (
    <svg
      width="1323"
      height="1977"
    ...
    >
      <g style={{ mixBlendMode: "plus-lighter" }} opacity="0.77">
        <path
          ...
          fill="url(#paint0_linear_7095_6344)"
          fillOpacity="0.8"
        />
      </g>
      <g style={{ mixBlendMode: "plus-lighter" }} opacity="0.51">
        <path
          ...
          fill="url(#paint1_linear_7095_6344)"
          fillOpacity="0.8"
        />
      </g>
      <defs>
        <linearGradient
          id="paint0_linear_7095_6344"
          x1="1442.53"
          y1="135.886"
          x2="244.078"
          y2="841.293"
