  ...
  return (
    ...
    >
      <div className="absolute top-[20%] lg:top-[15%] -translate-y-[15%] left-1/2 -translate-x-1/2 ">
        ...
        <TriamudomOpenhouse26Sm className="w-[80vw] block sm:hidden" />
      </div>
      ...
      <div className=" bottom-[5%] lg:-bottom-1/7 lg:top-1/2 left-1/2 -translate-x-1/2 absolute flex flex-col items-center justify-center space-y-6 z-40">
