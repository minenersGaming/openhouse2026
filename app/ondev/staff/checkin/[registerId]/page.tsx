...
export default function StaffBookingPage() {
  ...
  const [door, setDoor] = useState<"ประตูพญาไท" | "ประตูอังรีดูนังต์" | null>(
    null
  );
      ...
      <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-lg">
        ...
        {!data!.checkedIn && (
          <div className="mt-6 space-y-3">
            <p className="text-lg font-semibold text-center">Entrance Door</p>
        ...
        <button
          ...
          disabled={mutation.isPending || data!.checkedIn || !door}
