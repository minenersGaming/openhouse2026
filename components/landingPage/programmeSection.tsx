...
const ProgrammeSection = () => {
  return (
    ...
    >
      <div className=" pointer-events-none md:block absolute left-0 z-67 hidden overflow-hidden h-full">
        <LeftPillar className="pointer-events-none" />
      </div>
      <div className=" pointer-events-none md:block absolute right-0 z-67 hidden overflow-hidden h-full">
