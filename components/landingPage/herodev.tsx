...
const Herodev = () => {
  return (
    ...
    >
      ...
      <div className="absolute  bottom-[5%] lg:-bottom-1/5 lg:top-1/2 left-1/2 -translate-x-1/2 flex flex-col items-center justify-center space-y-5 z-6767">
        <div className="relative flex flex-col items-center justify-center space-y-5 z-6767">
          <Button />
