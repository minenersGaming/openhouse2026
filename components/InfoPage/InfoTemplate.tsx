...
const BigTextItem: Record<categoryType, JSX.Element[]> = {
  clubs: [
    ...
    <div
      key="clubs-1"
      className="flex flex-col justify-center sm:-space-y-2 items-start"
    >
      <p
...
const InfoTemplate = ({
  ...
  return (
    <div className="z-67 flex flex-col md:w-[50vw] items-center justify-center my-3">
      <div
      ...
      <div className={`${text == "" && "hidden"} ${TextBoxStyle}`}>
        <div
