  ...
  return (
    <>
      <div className="flex flex-col items-start justify-start my-1">
        ...
        {header === "7 มี.ค. 2569" && (
          <div className="absolute flex justify-center items-center rounded-[20px] translate-x-[220px] lg:translate-x-[480px] rotate-[6.7deg] translate-y-[15px] font-bold text-red px-2 bg-linear-to-r from-[#F08054] to-[#F8B044] drop-shadow-xl">
