const ClubsCard = ({ text, img }: { text: string; img: string }) => {
  return (
    <div className="drop-shadow-xl  hover:scale-105 transition-all duration-300 overflow-clip aspect-square w-50 lg:max-w-50 max-h-50 rounded-[20px] flex flex-col">
